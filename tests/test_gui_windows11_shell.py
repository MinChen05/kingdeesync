...
class Win11ScheduleAndHistoryCopyZhCnSmokeTests(QtAppTestCase):
    ...
    def test_history_page_key_copy_is_simplified_chinese(self) -> None:
        ...
        self.assertEqual(page.btn_prev.property("icon-source"), "icons/chevron_left.svg")
        self.assertEqual(page.btn_next.property("icon-source"), "icons/chevron_right.svg")
...
class Win11DashboardNoInlineStylesheetTests(QtAppTestCase):
    ...
    def test_dashboard_page_layout_uses_tokens(self) -> None:
        ...
        self.assertEqual(page.trend_card.range_btn.property("icon-source"), "icons/chevron_down.svg")
    ...
    def test_dashboard_recent_records_use_markers_and_tooltips(self) -> None:
        ...
        self.assertEqual(status_cell.mark_label.property("icon-source"), "icons/metric_pending_warning.svg")
        self.assertEqual(status_cell.text_label.property("tone"), "warning")
        self.assertEqual(page.recent_view_all_label.text(), "查看全部记录")
        self.assertEqual(page.recent_view_all_icon.property("icon-source"), "icons/chevron_right.svg")
        ...
        self.assertEqual(page.risk_view_all_icon.property("icon-source"), "icons/chevron_right.svg")
    ...
    def test_system_health_card_shows_four_services(self) -> None:
        ...
        self.assertEqual(hc._rows["kingdee"]["icon"].property("icon-source"), "icons/health_api.svg")
    ...
    def test_history_pagination_card_instantiates(self) -> None:
        ...
        self.assertEqual(card.btn_prev.property("icon-source"), "icons/chevron_left.svg")
        self.assertEqual(card.btn_next.property("icon-source"), "icons/chevron_right.svg")
